...
# --- 🛠️ FIXED: EVERYTHING IS OPTIONAL TO PREVENT 422 ERRORS ---
# ----------------------------------------------------
...
class HotspotItem(BaseModel):
    ...
    Hotspot_Level: Optional[str] = "Red"  # Default to Red to ensure color logic works
    ...
    class Config:
        # This allows Pydantic to map database fields to these names automatically
        populate_by_name = True
        from_attributes = True
        json_encoders = {datetime: lambda dt: dt.isoformat()}
